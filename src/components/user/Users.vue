<template>
  <div>
    ...
    <el-card>
        ...
        <el-table-column label="操作" width="150px">
          <template slot-scope="scope">
              ...
              <el-tooltip effect="dark" content="分配角色" placement="top" :enterable="false">
                <el-button type="warning" icon="el-icon-setting" circle size="small" @click="showSetRoleDialogVisible(scope.row)"></el-button>
              </el-tooltip>
          </template>
        </el-table-column>
      </el-table>
      ...
      <!-- 修改用户对话框 -->
      <el-dialog title="用户修改" :visible.sync="editDialogVisible" width="50%" @close="editDialogClose">
      ...
      <el-dialog title="分配角色" :visible.sync="setRoleDialogVisible" width="50%" @close="setRoleDialogVisibleClose">
        <div>
  ...
  methods: {
    async getUserList () {
      if (this.searchUser.length > 0) {
        this.queryInfo.query = this.searchUser
      } else {
